    ...
    <section id="experience" className="pb-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-sm font-semibold text-purple-600 tracking-wider uppercase">Timeline</h2>
          <p className="mt-2 text-2xl font-extrabold text-black tracking-tight sm:text-3xl">Work Experience</p>
        </div>

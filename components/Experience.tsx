    ...
    <section id="experience" className="pb-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-sm font-semibold text-[#0078d4] tracking-wider uppercase">Timeline</h2>
          <p className="mt-2 text-2xl font-extrabold text-black tracking-tight sm:text-3xl">Professional Experience</p>
        </div>
                    ...
                    <div className="relative flex space-x-4 items-start">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex justify-between items-center">
                            <p className="text-lg font-bold text-black">{job.role}</p>
                            <p className="text-sm text-gray-500 whitespace-nowrap">{job.period}</p>
                        </div>
